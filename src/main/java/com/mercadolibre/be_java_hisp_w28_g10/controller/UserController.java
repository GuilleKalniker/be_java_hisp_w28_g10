...
public class UserController {
    ...
    public ResponseEntity<UserFollowersDTO> getUserFollowers(@PathVariable int userId, @RequestParam String order) {
        return new ResponseEntity<>(userService.getUserFollowers(userId, order), HttpStatus.OK);
    }

    @GetMapping("/{userId}/followed/list")
    public ResponseEntity<UserFollowersDTO> getUserFollowed(@PathVariable Integer userId, @RequestParam String order) {
